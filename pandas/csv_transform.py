...
folder = 'E:/DE/ash/bin/' #локальная папка. для проверки заменить
...
df_sales.to_csv('E:/DE/ash/OUT/df_sales.csv', index=False, sep=';', encoding='utf-8-sig')
df_promo_fact.to_csv('E:/DE/ash/OUT/df_promo_fact.csv', index=False, sep=';', encoding='utf-8-sig')
df_promo_lookup.to_csv('E:/DE/ash/OUT/df_promo_lookup.csv', index=False, sep=';', encoding='utf-8-sig')
